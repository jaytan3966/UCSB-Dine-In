    ...
    return (
        <div className="grid grid-cols-2 lg:grid-cols-3 h-[91vh] text-center">
            ...
            <div className="flex flex-col justify-center items-center">
                <a href="https://dining.ucsb.edu/dining-commons" target="_blank" className="animate-fall">
                    <Image src="/ucsblogo.png" alt="UCSB Logo" height={300} width={300} priority/>
                </a>
                <button className="font-bold w-[50%] text-5xl sm:text-6xl text-white rounded-full bg-[#1d2f54] p-4 m-10 animate-appear hover:scale-110 duration-300 delay-150" onClick={() => handleScrollDown(topRef)}>DIG IN</button>
            </div>
